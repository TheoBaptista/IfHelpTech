        ...
        fun bind(question: Question) {
            ...
            sharedButton.setOnClickListener {
                val emailIntent = Intent(Intent.ACTION_SEND).apply {
                    setDataAndType(Uri.parse("mailto:${question.authorEmail}"), "text/plain")
                    putExtra(Intent.EXTRA_EMAIL, arrayOf(question.authorEmail))
                    putExtra(Intent.EXTRA_SUBJECT, "Resposta a pergunta: ${question.questionTitle}")
                    putExtra(
                        Intent.EXTRA_TEXT, "Título da pergunta: ${question.questionTitle} " +
                                "\n\nDescrição da pergunta: ${question.questionDescription}" +
                                "\n\nTópico da pergunta: ${question.questionTopic}\n\n" +
